  ...
  <section>
    <div class="main-container">
      <div class="container">
        ...
        <!-- Creative раздел наши партнеры создано облаком брендов (как облако тегов) -->
    ...
    <div class="infoblock">
      ...
      <div class="testimonial-preview">
        <div class="testimonial-avatar">
          <img src="img/people/p1.jpg" alt="Avatar 1">
        </div>
      ...
      <div class="testimonial-preview">
        <div class="testimonial-avatar">
          <img src="img/people/p2.jpg" alt="Avatar 2">
        </div>
        <div class="testimonial-content">
          <div class="testimonial-author">Peter</div>
          <div class="testimonial-text">
      ...
      <a href="recenzie.php" class="btn btn-primary">Prečítať si všetky recenzie</a>
